...
[0] = LAYOUT(
  ...
  KC_ESC,   MT(MOD_LCTL, KC_A),   MT(MOD_LALT, KC_S),    MT(MOD_LGUI, KC_D),    MT(MOD_LSFT, KC_F),    KC_G,                     KC_H,    MT(MOD_LSFT, KC_J),   MT(MOD_LGUI, KC_K),    MT(MOD_LALT, KC_L),    MT(MOD_LCTL, KC_SCLN),  KC_QUOT,
  MT(MOD_LSFT,KC_MINS),  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LEFT,KC_RIGHT,KC_LCTL, MO(2), KC_ENT,      KC_SPC,  MO(3), KC_BSPC, KC_DOWN, KC_UP
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
